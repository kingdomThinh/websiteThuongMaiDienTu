<footer class="footer">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-6 col-ssm">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <p><b><i class="fas fa-mobile-alt"></i> Hotline:</b> <a href="tel:(+84) 967 999 999">(+84) 967 999 000</a></p>
              <p><b><i class="fas fa-envelope"></i> Email:</b> <a href="mailto:minitiki@gmail.com" rel="nofollow">minitiki@gmail.com</a></p>
        ...
        <div class="col-md-3 col-sm-4 hidden-xs">
          <div class="footer-widget">
            ...
            <div class="widget-content">
            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FTh%25C6%25B0%25C6%25A1ng-m%25E1%25BA%25A1i-%25C4%2591i%25E1%25BB%2587n-t%25E1%25BB%25AD-MiniTiki-103398188380995&tabs=timeline&width=270&height=130&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=588748341759321" width="270" height="130" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="footer-bottom">
    <div class="copyright text-center">
      Đồ án chuyên ngành 2020 Mùi Thịnh Lộc. All rights reserved.
    </div>
  </div>
</footer>
