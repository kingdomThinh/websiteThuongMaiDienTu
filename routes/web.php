...
Route::get('/project/create','App\Http\Controllers\Project\ProjectController@create');
  //page products
...
Route::get('/login_facebook', 'App\Http\Controllers\LoginController@login_facebook');
Route::get('/callback', 'App\Http\Controllers\LoginController@callback_facebook');